...
<button onClick={logout} style={{ width:'100%', textAlign:'left', padding:'6px 8px', marginTop:'4px', color:'#006614', fontFamily:'monospace', fontSize:'0.7rem', background:'none', border:'none', cursor:'pointer' }}>
[LOGOUT]
</button>
</div>
</aside>
