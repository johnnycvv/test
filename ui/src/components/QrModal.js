...
<div style={{width:'100%',maxWidth:'460px',background:'rgba(0,8,0,0.97)',border:'1px solid rgba(0,255,65,0.3)',borderRadius:'8px',padding:'24px'}}>
    <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'20px'}}>
      <div>
        <div style={{color:'#00ff41',fontFamily:'monospace',fontSize:'0.9rem',fontWeight:'bold',letterSpacing:'0.1em'}}>[ SIP SOFTPHONE CONFIG ]</div>
    ...
    {loading && (
      <div style={{textAlign:'center',padding:'32px',color:'#006614',fontFamily:'monospace',fontSize:'0.8rem'}}>[ GENERATING SIP CONFIG... ]</div>
    )}
    ...
    {qrDataUrl && (
      <>
        <div style={{textAlign:'center',marginBottom:'16px'}}>
          <div style={{display:'inline-block',background:'#000',padding:'12px',borderRadius:'4px',border:'2px solid rgba(0,255,65,0.4)'}}>
        ...
        {tab === 'manual' && (
          <div style={{background:'rgba(0,15,0,0.6)',border:'1px solid rgba(0,255,65,0.15)',borderRadius:'4px',padding:'14px',marginBottom:'16px'}}>
            ...
            <div style={{background:'rgba(0,20,0,0.8)',border:'1px solid rgba(0,255,65,0.1)',borderRadius:'4px',padding:'10px',fontFamily:'monospace',fontSize:'0.75rem'}}>
              <div style={{color:'#006614'}}>SIP URI:</div>
              <div style={{color:'#00ff41',wordBreak:'break-all'}}>{sipUri}</div>
            </div>
          </div>
        )}
        ...
        <div style={{display:'flex',gap:'8px'}}>
          ...
          <a href={qrDataUrl} download={agent.display_name + '-sip-qr.png'} style={{flex:1,padding:'10px',background:'rgba(0,255,65,0.08)',border:'1px solid rgba(0,255,65,0.25)',color:'#00ff41',fontFamily:'monospace',fontSize:'0.75rem',cursor:'pointer',borderRadius:'4px',textDecoration:'none',textAlign:'center',display:'flex',alignItems:'center',justifyContent:'center'}}>
            [ DOWNLOAD QR ]
          </a>
        </div>
      </>
